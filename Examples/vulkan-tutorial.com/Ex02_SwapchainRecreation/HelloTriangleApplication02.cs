...
{
	/*
	 * Source: https://vulkan-tutorial.com/Drawing_a_triangle/Swap_chain_recreation
	 * */
	...
	public class HelloTriangleApplication02
	{
		...
		{
			var app = (HelloTriangleApplication02)GLFW.glfwGetWindowUserPointer(window);
