...
{
	/*
	 * Source: https://vulkan-tutorial.com/Vertex_buffers/Index_buffer
	 * */
	...
	public class HelloTriangleApplication05
	{
		...
		{
			var app = (HelloTriangleApplication05)GLFW.glfwGetWindowUserPointer(window);
		...
		{
			var vertShaderModule = createShaderModule(typeof(Shader_Vert_05));
			var fragShaderModule = createShaderModule(typeof(Shader_Frag_05));
