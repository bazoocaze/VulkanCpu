...
namespace Examples.vulkan_tutorial.com.Ex04_StagingBuffer
{
	...
	public class HelloTriangleApplication04
	{
		...
		{
			Vertex.Create(0.0f, -0.5f, 1.0f, 0.0f, 0.0f),
		...
		{
			var app = (HelloTriangleApplication04)GLFW.glfwGetWindowUserPointer(window);
		...
		{
			var vertShaderModule = createShaderModule(typeof(Shader_Vert_04));
			var fragShaderModule = createShaderModule(typeof(Shader_Frag_04));
